...
<div class="card mt-5">
    ...
    <div class="card-body">
        <form method="POST" action="{{route('profile.savePost')}}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="exampleFormControlInput1">لینک را به انگلیسی بنویسی</label>
                <input name="slug" type="text" class="form-control" id="exampleFormControlInput1" placeholder="عنوان را وارد کنید">
            </div>
            <div class="form-group">
                <label for="exampleFormControlSelect1">دسته مورد نظر را انتخاب کنید </label>
            ...
            <div class="form-group">
                <label for="validatedCustomFile">یک عکس برای کاور انتخاب کنید...</label>
                <input name="image" type="file" class="form-control" accept="image/jpeg,png,jpg,gif,svg" required>

            </div>

            <div class="form-group">
                <label for="exampleFormControlTextarea1">متن خود را وارد کنید</label>
